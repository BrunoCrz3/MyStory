...
- Migraciones hasta `0011_saneamiento_brief.sql`; la siguiente es `0012_regeneracion.sql` (P40). Informe de crítica: `quality.registrar_informe` desde `process/capitulo._decidir_y_registrar`.
