"""Lanzador: `uv run python -m app [--host H] [--port P] [--reload] [--permitir-red]`.
...
worker**, porque el pool en vuelo es un semáforo en proceso (RF-PROC-03).
"""
...
def main(argv: list[str] | None = None) -> None:
    uvicorn.run(**argumentos_uvicorn(sys.argv[1:] if argv is None else argv))
